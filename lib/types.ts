...
export type PressArticle={_id:string;title:string;slug:string;date:string;medium?:string;excerpt?:string;url?:string;image?:unknown}; export type Page={_id:string;title:string;slug:string;seoTitle?:string;seoDescription?:string};
