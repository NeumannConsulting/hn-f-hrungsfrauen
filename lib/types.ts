...
export type Page={_id:string;title:string;slug:string;eyebrow?:string;intro?:string;heroImage?:unknown;featureImage?:unknown;secondaryImage?:unknown;seoTitle?:string;seoDescription?:string};
