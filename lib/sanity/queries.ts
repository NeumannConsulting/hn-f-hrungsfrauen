...
export const pageBySlugQuery = `*[_type == "page" && _id == $id][0]{_id, title, "slug": slug.current, eyebrow, intro, heroImage, featureImage, secondaryImage, bodyTitle, bodyText, timelineTitle, timeline[]{year, text}, seoTitle, seoDescription}`;
