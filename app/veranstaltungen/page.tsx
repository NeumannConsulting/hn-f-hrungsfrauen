...
import { getEvents } from '@/lib/sanity/data';
export const metadata = { title: 'Veranstaltungen' };
export default async function EventsPage() {
  const now = new Date().toISOString(); const events = await getEvents();
